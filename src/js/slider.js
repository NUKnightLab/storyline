 ...
 */
export class Slider {
    constructor(storyline, markers, cards, config, startIndex, height, width) {
    ...
    setActiveCard(pastActiveCard, currentActiveCard) {
...
const MUSTACHE_TEMPLATES = {
    "slider-cards-template": "<div class='slider-cards'>" +
        "{{#cards}}" +
